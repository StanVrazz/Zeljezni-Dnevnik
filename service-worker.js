const CACHE = "zeljezni-dnevnik-v10";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./images/leg-press.png","./images/iron-cover.png","./images/iron-weight-texture.png","./images/iron-weight-texture-hd.png","./images/iron-weight-texture-clean.png",
